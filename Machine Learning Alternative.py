...
df = pd.read_csv('outputascsv_1.csv', index_col = False, header=0)
...
drawPointsOnMap(superMap, [endPoint], '#ff0000', 30)
line = getLineFromPoints(clustersCenters, endPoint)

superMap.add_child(folium.PolyLine(locations = line, weight = 10, color="#d63b3b"))
